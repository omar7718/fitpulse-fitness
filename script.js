...
const translations = {
    en: {
        ...
        heroText: "Join Fitpulse Fitness today and experience state-of-the-art facilities, expert trainers, and a community that supports your fitness journey.",
        viewMemberships: "View Memberships",
        bookClass: "Book a Class",

        // Features
        whyChoose: "Why Choose Fitpulse?",
        featuresDesc: "We offer everything you need to achieve your fitness goals in a supportive and motivating environment.",
        modernEquipment: "Modern Equipment",
        equipmentDesc: "Access to the latest fitness technology and equipment for all your workout needs.",
        expertTrainers: "Expert Trainers",
        trainersDesc: "Certified professionals to guide and motivate you through your fitness journey.",
        flexibleSchedule: "Flexible Schedule",
        scheduleDesc: "Classes and training sessions available throughout the day to fit your busy lifestyle.",

        // Testimonials
        testimonialsTitle: "What Our Members Say",
        testimonialsDesc: "Hear from our satisfied members who have transformed their lives with Fitpulse Fitness.",

        // Membership
        membershipTitle: "Membership Plans",
        membershipDesc: "Choose the plan that fits your fitness goals and budget. All plans include access to our state-of-the-art facilities.",
        basic: "Basic",
        premium: "Premium",
        elite: "Elite",
        month: "month",
        ...
        allGroupClasses: "All Group Classes",
        personalSessions: "Personal Sessions",

        // Schedule
        scheduleTitle: "Class Schedule",
        scheduleDesc: "Book your favorite classes with our easy-to-use scheduling system. Filter by class type to find what you're looking for.",
        ...
        clickToRegister: "Click on any class above to register!",
        ...
        trainersDesc: "Our certified personal trainers bring years of experience and proven results to help you achieve your fitness goals.",
        ...
        contactDesc: "Have questions or ready to start your fitness journey? Contact us today!",
        ourLocation: "Our Location",
        phoneNumber: "Phone Number",
        emailAddress: "Email Address",
        openingHours: "Opening Hours",
        hoursWeekdays: "Monday - Friday: 5:00 AM - 11:00 PM",
        hoursWeekend: "Saturday - Sunday: 7:00 AM - 9:00 PM",
        yourName: "Your Name",
    ...
    ar: {
        ...
        // Features
        whyChoose: "لماذا تختار فيتبلس؟",
        featuresDesc: "نوفر كل ما تحتاجه لتحقيق أهدافك الرياضية في بيئة داعمة ومحفزة.",
        modernEquipment: "معدات حديثة",
        equipmentDesc: "الوصول إلى أحدث تقنيات ومعدات اللياقة البدنية لجميع احتياجاتك التدريبية.",
        expertTrainers: "مدربون خبراء",
        trainersDesc: "محترفون معتمدون لتوجيهك وتحفيزك خلال رحلتك الرياضية.",
        flexibleSchedule: "جدول مرن",
        scheduleDesc: "حصص وجلسات تدريبية متاحة طوال اليوم لتناسب نمط حياتك المزدحم.",

        // Testimonials
        testimonialsTitle: "ماذا يقول أعضاؤنا",
        testimonialsDesc: "استمع إلى أعضائنا الراضين الذين غيروا حياتهم مع فيتبلس.",

        // Membership
        membershipTitle: "خطط العضوية",
        membershipDesc: "اختر الخطة التي تناسب أهدافك الرياضية وميزانيتك. جميع الخطط تشمل الوصول إلى مرافقنا الحديثة.",
        basic: "أساسي",
        premium: "مميز",
        elite: "النخبة",
        month: "شهر",
        ...
        // Membership Features
        gymAccess: "الدخول إلى الصالة",
        lockerRoom: "غرفة خلع الملابس",
        groupClasses: "الحصص الجماعية",
        personalTraining: "تدريب شخصي",
        nutritionPlanning: "تخطيط التغذية",
        allGroupClasses: "جميع الحصص الجماعية",
        personalSessions: "جلسات شخصية",

        // Schedule
        scheduleTitle: "جدول الحصص",
        scheduleDesc: "احجز حصصك المفضلة بنظام الحجز السهل الاستخدام. تصفية حسب نوع الحصة للعثور على ما تبحث عنه.",
        allClasses: "جميع الحصص",
        yoga: "يوجا",
        cardio: "كارديو",
        strength: "قوة",
        hiit: "تمرين مكثف",
        bookClassNow: "احجز حصة الآن",
        yourRegisteredClasses: "الحصص المسجلة لديك",
        noClassesRegistered: "لا توجد حصص مسجلة بعد",
        clickToRegister: "انقر على أي حصة أعلاه للتسجيل!",
        ...
        // Trainers
        trainersTitle: "تعرف على مدربينا الخبراء",
        trainersDesc: "يقدم مدربونا الشخصيون المعتمدون سنوات من الخبرة ونتائج مثبتة لمساعدتك في تحقيق أهدافك الرياضية.",
        ...
        contactDesc: "هل لديك أسئلة أو مستعد لبدء رحلتك الرياضية؟ اتصل بنا اليوم!",
        ourLocation: "موقعنا",
        phoneNumber: "رقم الهاتف",
        emailAddress: "البريد الإلكتروني",
        openingHours: "ساعات العمل",
        hoursWeekdays: "الاثنين - الجمعة: 5:00 ص - 11:00 م",
        hoursWeekend: "السبت - الأحد: 7:00 ص - 9:00 م",
        yourName: "اسمك",
...
function setupClassBooking() {
    ...
    function registerClass(className, classType, day, time) {
        ...
        if (!canRegisterForClasses()) {
            if (!isUserLoggedIn()) {
                ...
                showNotification('Please activate a membership plan before booking classes', 'warning');
                showPage('membership');
            }
            return false;
        }
    ...
    function isClassAlreadyRegistered(className, classDay, classTime) {
        return registeredClasses.some(classItem =>
            ...
            classItem.day === classDay &&
            classItem.time === classTime
        );
    }
...
function setupPlanSelection() {
    ...
    function openPlanModal(planType, planPrice) {
    ...
    function activateUserPlan(planName, planPrice) {
        // STRICT CHECK: User must be logged in to activate plan
        if (!isUserLoggedIn()) {
        ...
        // Save plan activation to localStorage
        ...
        // Update UI to reflect new authentication status
        updateUIBasedOnAuth();

        // Update class booking system to reflect new plan status
        if (window.classBookingSystem) {
            window.classBookingSystem.updateLoginRequiredMessage();
    ...
    modalBookBtn.addEventListener('click', function () {
        ...
        if (!canRegisterForClasses()) {
            if (!isUserLoggedIn()) {
                ...
                showNotification('Please activate a membership plan to book training sessions', 'warning');
                showPage('membership');
            }
            return;
        }
